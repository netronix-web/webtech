...
if (isset($_POST['trimis'])) {
		for($i=1;$i<8;$i++){
			...
			if ($n_c >=0) { // Daca au rulat corect toate queryurile.
				...
				//echo '<center><table border=0><tr><td><font color="navy" size="2"> Valorile au fost trimise!</td>';
				//echo '<td><a href="val_tp_m.php"> <img src="sg.gif"> </a></td></tr></table></center>';
				//exit();			
				//header("Location: $url");
...
<div id="displ_gr" style="position:relative;height:220px;width:120px;"></div>
</td></tr></table>
<script>
