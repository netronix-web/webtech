...
public class instr_v6 extends JApplet {
	...
	*/
			...
			if (timer_1 == null) {
					...
					timer_1.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
					        ...
					        if (icon != null) {
					        	etich_3.setText("");
								etich_3.setIcon(icon);
					        } else { //image not found
					        	etich_3.setText("im.jpg - not found");
					        }
					        if (grf == null){
							...
							grf.drawLine(350, 40, 200+slider_1.getValue(),150);	
						}
					});					
    }
}	
	...
	private JButton creaza_but_1() {
		if (but_1 == null) {
			but_1 = new JButton();
			but_1.setBounds(new Rectangle(220, 280, 100, 30));
			but_1.setText("Repaint");
	...
	private JPanel init_panel_1() {
		if (c_panel_1 == null) {		
			...
			etich_3 = new JLabel();
			etich_3.setBounds(new Rectangle(150, 40, 350, 150));
			etich_3.setText("");
			icon = new ImageIcon("im.jpg","meter");
			c_panel_1 = new JPanel();
			c_panel_1.setLayout(null);
			c_panel_1.add(etich_1, null);
			c_panel_1.add(etich_2, null);
			c_panel_1.add(etich_3, null);
